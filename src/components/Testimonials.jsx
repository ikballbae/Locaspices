  ...
  return (
    ...
    className="container mx-auto py-10 lg:px-32 w-full overflow-hidden" id="Testimonials">
      <h1 className="text-2xl sm:text-4xl font-bold mb-2 text-center">
        Spice <span className="underline underline-offset-4 decoration-1 font-light">Reviews</span>
      </h1>
      <p className="text-center text-gray-500 mb-12 max-w-80 mx-auto">
        Real Stories from Those Who Have Transformed Their Dishes with Our Spices
      </p>
